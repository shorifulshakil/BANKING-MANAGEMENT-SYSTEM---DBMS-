...
<head>
    ...
    <title>Insurance Details - SHORIF THE SWITCH BANK</title>
    <style>
        /* Global Styles */
        body {
...
<body>
    <header>
        <h1>SHORIF THE SWITCH BANK - Insurance Details</h1>
    </header>
    ...
    <footer>
        <p>&copy; 2024 SHORIF THE SWITCH BANK. All rights reserved.</p>
    </footer>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            addInsuranceForm.addEventListener('submit', event => {
                ...
                const newInsurance = {
                    insurance_id: Math.floor(Math.random() * 100000),
                    customer_id: Math.floor(Math.random() * 10000000000),
